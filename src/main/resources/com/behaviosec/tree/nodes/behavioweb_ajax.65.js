var replacementSessionId = "REPLACEMENT_SESSION_ID";
var replacementJourneyId = "REPLACEMENT_JOURNEY_ID";

document.cookie = "com.behaviosec.api.check_cookie_param_sessionId=REPLACEMENT_SESSION_ID; path=/";
document.cookie = "com.behaviosec.api.check_cookie_param_journeyId=REPLACEMENT_JOURNEY_ID; path=/";
...
if (Monitor.prototype = {
    ...
    navigating: !0,
    collectorEndpoint: "REPLACEMENT_URLBehavioSenseAPI/GetAjaxAsync",
    tenantid: "REPLACEMENT_TENANTID",
    metaNames: {
        journeyid: "bwjourid",
        userid: "bwuuid",
        sessionid: "bwsessid",
    ...
    prepHttpStr: function(options) {
        var retStr = "";
        retStr += "journeyid=" + replacementJourneyId;
        //retStr += "&sessionid=" + replacementSessionId;
...
var submitCollectedData = function functionSubmitCollectedData() {
    ...
    outputVariable.value = "journeyid=" + replacementJourneyId + "&sessionid=" + replacementSessionId;
}
