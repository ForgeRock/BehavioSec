...
var submitCollectedData = function functionSubmitCollectedData() {
    ...
    if (!(loginHelpers === undefined)) {
        ...
        console.log("loginHelpers is defined");
        //alert("loginHelpers is defined");
    } else {
        //alert("loginHelpers is undefined");
        console.log("loginHelpers is undefined");
    }
}

if (!(loginHelpers === undefined)) {
    if (loginHelpers) {
        console.log("loginHelpers");
        loginHelpers.nextStepCallback(submitCollectedData)
    }
} else {
    console.log("loginHelpers is still undefined");
}
