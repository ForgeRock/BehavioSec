...
var f1 = function test() {
    console.log("Here 3");
//      alert("Hello 3");
};

var f4 = function test2() {
...
if (document.getElementsByClassName("form-control")[0] != undefined) {
    console.log("here 1");
    var userNameField = document.getElementsByClassName("form-control")[0];
    userNameField.addEventListener("blur", f2);
    console.log("here 2");
}
