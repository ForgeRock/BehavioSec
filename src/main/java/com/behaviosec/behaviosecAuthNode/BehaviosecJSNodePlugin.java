 ...
 * @since AM 5.5.0
 */
public class BehaviosecJSNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(BehaviosecJSNodePlugin.currentVersion, 
				Collections.singletonList(BehaviosecJSNode.class));
	}
	...
	public String getPluginVersion() {
		return BehaviosecJSNodePlugin.currentVersion;
	}
}
